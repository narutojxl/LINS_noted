...
if(lins_CONFIG_INCLUDED)
  return()
endif()
set(lins_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lins_SOURCE_PREFIX /home/jxl/Lins_ws/src/LINS---LiDAR-inertial-SLAM_noted/lins)
  set(lins_DEVEL_PREFIX /home/jxl/Lins_ws/src/LINS---LiDAR-inertial-SLAM_noted/build/devel)
  set(lins_INSTALL_PREFIX "")
  set(lins_PREFIX ${lins_DEVEL_PREFIX})
else()
  set(lins_SOURCE_PREFIX "")
  set(lins_DEVEL_PREFIX "")
  set(lins_INSTALL_PREFIX /usr/local)
  set(lins_PREFIX ${lins_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lins' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jxl/Lins_ws/src/LINS---LiDAR-inertial-SLAM_noted/build/devel/lib;/home/jxl/Lins_ws/devel/lib;/home/jxl/jxl_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lins_LIBRARY_DIRS ${lib_path})
      list(APPEND lins_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lins'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lins_LIBRARIES ${lib})
    endif()
  endif()
...
set(lins_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lins_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 lins_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lins_dep}_FOUND)
      find_package(${lins_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lins_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lins_INCLUDE_DIRS ${${lins_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lins_LIBRARIES ${lins_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lins_dep}_LIBRARIES})
  _list_append_deduplicate(lins_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lins_LIBRARIES ${lins_LIBRARIES})

  _list_append_unique(lins_LIBRARY_DIRS ${${lins_dep}_LIBRARY_DIRS})
  list(APPEND lins_EXPORTED_TARGETS ${${lins_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lins_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
